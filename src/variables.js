	...
	initVariables() {
		...
		if (model) {
			...
			if (model.variables.includes('gminp')) {
				...
				variables.push({
					variableId: `gminp_miclineinput1_mic_phantompower`,
					name: `Mic/Line Input 1 Mic Phantom Power`,
				})
				...
				variables.push({
					variableId: `gminp_miclineinput1_mic_eq1_frequency`,
					name: `Mic/Line Input 1 Mic EQ 1 Frequency`,
				})
				...
				variables.push({
					variableId: `gminp_miclineinput1_mic_eq1_filtertype`,
					name: `Mic/Line Input 1 Mic EQ 1 Filter Type`,
				})

				variables.push({
					variableId: `gminp_miclineinput1_mic_eq2_frequency`,
					name: `Mic/Line Input 1 Mic EQ 2 Frequency`,
				})
				...
				variables.push({
					variableId: `gminp_miclineinput1_mic_eq2_filtertype`,
					name: `Mic/Line Input 1 Mic EQ 2 Filter Type`,
				})

				variables.push({
					variableId: `gminp_miclineinput1_mic_eq3_frequency`,
					name: `Mic/Line Input 1 Mic EQ 3 Frequency`,
				})
				...
				variables.push({
					variableId: `gminp_miclineinput1_mic_eq3_filtertype`,
					name: `Mic/Line Input 1 Mic EQ 3 Filter Type`,
				})

				variables.push({
					variableId: `gminp_miclineinput1_line_phantompower`,
					name: `Mic/Line Input 1 Line Phantom Power`,
				})
				...
				variables.push({
					variableId: `gminp_miclineinput1_line_eq1_frequency`,
					name: `Mic/Line Input 1 Line EQ 1 Frequency`,
				})
				...
				variables.push({
					variableId: `gminp_miclineinput1_line_eq1_filtertype`,
					name: `Mic/Line Input 1 Line EQ 1 Filter Type`,
				})

				variables.push({
					variableId: `gminp_miclineinput1_line_eq2_frequency`,
					name: `Mic/Line Input 1 Line EQ 2 Frequency`,
				})
				...
				variables.push({
					variableId: `gminp_miclineinput1_line_eq2_filtertype`,
					name: `Mic/Line Input 1 Line EQ 2 Filter Type`,
				})

				variables.push({
					variableId: `gminp_miclineinput1_line_eq3_frequency`,
					name: `Mic/Line Input 1 Line EQ 3 Frequency`,
				})
				...
				variables.push({
					variableId: `gminp_miclineinput1_line_eq3_filtertype`,
					name: `Mic/Line Input 1 Line EQ 3 Filter Type`,
				})
				...
				variables.push({
					variableId: `gminp_miclineinput2_mic_phantompower`,
					name: `Mic/Line Input 2 Mic Phantom Power`,
				})
				...
				variables.push({
					variableId: `gminp_miclineinput2_mic_eq1_frequency`,
					name: `Mic/Line Input 2 Mic EQ 1 Frequency`,
				})
				...
				variables.push({
					variableId: `gminp_miclineinput2_mic_eq1_filtertype`,
					name: `Mic/Line Input 2 Mic EQ 1 Filter Type`,
				})

				variables.push({
					variableId: `gminp_miclineinput2_mic_eq2_frequency`,
					name: `Mic/Line Input 2 Mic EQ 2 Frequency`,
				})
				...
				variables.push({
					variableId: `gminp_miclineinput2_mic_eq2_filtertype`,
					name: `Mic/Line Input 2 Mic EQ 2 Filter Type`,
				})

				variables.push({
					variableId: `gminp_miclineinput2_mic_eq3_frequency`,
					name: `Mic/Line Input 2 Mic EQ 3 Frequency`,
				})
				...
				variables.push({
					variableId: `gminp_miclineinput2_mic_eq3_filtertype`,
					name: `Mic/Line Input 2 Mic EQ 3 Filter Type`,
				})

				variables.push({
					variableId: `gminp_miclineinput2_line_phantompower`,
					name: `Mic/Line Input 2 Line Phantom Power`,
				})
				...
				variables.push({
					variableId: `gminp_miclineinput2_line_eq1_frequency`,
					name: `Mic/Line Input 2 Line EQ 1 Frequency`,
				})
				...
				variables.push({
					variableId: `gminp_miclineinput2_line_eq1_filtertype`,
					name: `Mic/Line Input 2 Line EQ 1 Filter Type`,
				})

				variables.push({
					variableId: `gminp_miclineinput2_line_eq2_frequency`,
					name: `Mic/Line Input 2 Line EQ 2 Frequency`,
				})
				...
				variables.push({
					variableId: `gminp_miclineinput2_line_eq2_filtertype`,
					name: `Mic/Line Input 2 Line EQ 2 Filter Type`,
				})

				variables.push({
					variableId: `gminp_miclineinput2_line_eq3_frequency`,
					name: `Mic/Line Input 2 Line EQ 3 Frequency`,
				})
				...
				variables.push({
					variableId: `gminp_miclineinput2_line_eq3_filtertype`,
					name: `Mic/Line Input 2 Line EQ 3 Filter Type`,
				})
			...
			if (model.variables.includes('giinp')) {
				...
				variables.push({
					variableId: `giinp_interpretationreturn1_nominallevel`,
					name: `Interpretation Return 1 Nominal Level`,
				})
				variables.push({ variableId: `giinp_interpretationreturn1_lowcut`, name: `Interpretation Return 1 Low Cut` })

				variables.push({
					variableId: `giinp_interpretationreturn1_eq1_frequency`,
					name: `Interpretation Return 1 EQ 1 Frequency`,
				})
				variables.push({
					variableId: `giinp_interpretationreturn1_eq1_gain`,
					name: `Interpretation Return 1 EQ 1 Gain`,
				})
				variables.push({
					variableId: `giinp_interpretationreturn1_eq1_q`,
					name: `Interpretation Return 1 EQ 1 Q Value`,
				})
				variables.push({
					variableId: `giinp_interpretationreturn1_eq1_filtertype`,
					name: `Interpretation Return 1 EQ 1 Filter Type`,
				})

				variables.push({
					variableId: `giinp_interpretationreturn1_eq2_frequency`,
					name: `Interpretation Return 1 EQ 2 Frequency`,
				})
				variables.push({
					variableId: `giinp_interpretationreturn1_eq2_gain`,
					name: `Interpretation Return 1 EQ 2 Gain`,
				})
				variables.push({
					variableId: `giinp_interpretationreturn1_eq2_q`,
					name: `Interpretation Return 1 EQ 2 Q Value`,
				})
				variables.push({
					variableId: `giinp_interpretationreturn1_eq2_filtertype`,
					name: `Interpretation Return 1 EQ 2 Filter Type`,
				})

				variables.push({
					variableId: `giinp_interpretationreturn1_eq3_frequency`,
					name: `Interpretation Return 1 EQ 3 Frequency`,
				})
				variables.push({
					variableId: `giinp_interpretationreturn1_eq3_gain`,
					name: `Interpretation Return 1 EQ 3 Gain`,
				})
				variables.push({
					variableId: `giinp_interpretationreturn1_eq3_q`,
					name: `Interpretation Return 1 EQ 3 Q Value`,
				})
				variables.push({
					variableId: `giinp_interpretationreturn1_eq3_filtertype`,
					name: `Interpretation Return 1 EQ 3 Filter Type`,
				})

				variables.push({ variableId: `giinp_interpretationreturn2_level`, name: `Interpretation Return 2 Level` })
				variables.push({
					variableId: `giinp_interpretationreturn2_nominallevel`,
					name: `Interpretation Return 2 Nominal Level`,
				})
				variables.push({ variableId: `giinp_interpretationreturn2_lowcut`, name: `Interpretation Return 2 Low Cut` })

				variables.push({
					variableId: `giinp_interpretationreturn2_eq1_frequency`,
					name: `Interpretation Return 2 EQ 1 Frequency`,
				})
				variables.push({
					variableId: `giinp_interpretationreturn2_eq1_gain`,
					name: `Interpretation Return 2 EQ 1 Gain`,
				})
				variables.push({
					variableId: `giinp_interpretationreturn2_eq1_q`,
					name: `Interpretation Return 2 EQ 1 Q Value`,
				})
				variables.push({
					variableId: `giinp_interpretationreturn2_eq1_filtertype`,
					name: `Interpretation Return 2 EQ 1 Filter Type`,
				})

				variables.push({
					variableId: `giinp_interpretationreturn2_eq2_frequency`,
					name: `Interpretation Return 2 EQ 2 Frequency`,
				})
				variables.push({
					variableId: `giinp_interpretationreturn2_eq2_gain`,
					name: `Interpretation Return 2 EQ 2 Gain`,
				})
				variables.push({
					variableId: `giinp_interpretationreturn2_eq2_q`,
					name: `Interpretation Return 2 EQ 2 Q Value`,
				})
				variables.push({
					variableId: `giinp_interpretationreturn2_eq2_filtertype`,
					name: `Interpretation Return 2 EQ 2 Filter Type`,
				})

				variables.push({
					variableId: `giinp_interpretationreturn2_eq3_frequency`,
					name: `Interpretation Return 2 EQ 3 Frequency`,
				})
				variables.push({
					variableId: `giinp_interpretationreturn2_eq3_gain`,
					name: `Interpretation Return 2 EQ 3 Gain`,
				})
				variables.push({
					variableId: `giinp_interpretationreturn2_eq3_q`,
					name: `Interpretation Return 2 EQ 3 Q Value`,
				})
				variables.push({
					variableId: `giinp_interpretationreturn2_eq3_filtertype`,
					name: `Interpretation Return 2 EQ 3 Filter Type`,
				})
			}
			...
			if (model.variables.includes('gaout')) {
				...
				variables.push({
					variableId: `gaout_output1_dynamics_limiterthreshold`,
					name: `Output 1 Dynamics Limiter Threshold`,
				})
			...
			if (model.variables.includes('glvmt')) {
				for (let i = 0; i < constants.monitor_points.length; i++) {
					...
					variables.push({
						variableId: `glvmt_monitorpoint_${point.id}_level`,
						name: `Monitor Point ${point.label} Level`,
					})
				}
			}
		...
		try {
			...
			if (model) {
				...
				if (model.variables.includes('giinp')) {
					...
					variableObj[`giinp_interpretationreturn1_eq1_filtertype`] =
						this.DATA.giinp.interpretationreturn1_eq1_filtertype
					...
					variableObj[`giinp_interpretationreturn1_eq2_filtertype`] =
						this.DATA.giinp.interpretationreturn1_eq2_filtertype
					...
					variableObj[`giinp_interpretationreturn1_eq3_filtertype`] =
						this.DATA.giinp.interpretationreturn1_eq3_filtertype
					...
					variableObj[`giinp_interpretationreturn2_eq1_filtertype`] =
						this.DATA.giinp.interpretationreturn2_eq1_filtertype
					...
					variableObj[`giinp_interpretationreturn2_eq2_filtertype`] =
						this.DATA.giinp.interpretationreturn2_eq2_filtertype
					...
					variableObj[`giinp_interpretationreturn2_eq3_filtertype`] =
						this.DATA.giinp.interpretationreturn2_eq3_filtertype
				}
